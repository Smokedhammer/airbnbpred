...
def bug_fixer(data, fixed, api_key):
    try:
        ...
        # Create the message
        prompt_message = data+ "Knowing the data, answer the following question to the user in a realistic,simple way.Use the data to support the answers " + fixed + "It is in log log model, convert it to %s in the proper way. The percentage changes will be be small. Tell the user how much it matters and the implications of the answer as well. If the question is not relevant to context tell them its not a relevant question " 
