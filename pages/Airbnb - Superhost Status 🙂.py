...
def bug_fixer(data, fixed, api_key):
    try:
        ...
        # Create the message
        prompt_message = data+ "Knowing the data, answer the following question to the user in a realistic,simple way.Use the data to support the answers " + fixed + "Interpret the coefficients (Dont give percentages, use only coefficients in your answers). Tell the user how much it matters and the implications of the answer as well. If the question is not relevant to context tell them its not a relevant question " 
