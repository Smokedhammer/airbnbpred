...
def bug_fixer(data, fixed, api_key):
    try:
        ...
        # Create the message
        prompt_message = data+ "Knowing the data, answer the following question to the user in a realistic,simple way.Use the data to support the answers " + fixed + "Coefficients are in log-log form,convert to percentages wherever needed using the relevant processes. Tell the user how much it matters and the implications of the answer as well. If the question is not relevant to context tell them its not a relevant question " 
